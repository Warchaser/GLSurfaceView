...
import com.warchaser.titlebar.TitleBar;
...
final public class StatusBarUtil {
    ...
    private static void cutOutTitleBar(TitleBar titleBar, Context context){
        ...
        try{
            ...
            final int originPaddingTop = dip2px(15f, context);
            final int minus = statusBarHeight - originPaddingTop;
            layoutParams.height = minus + titleBar.getHeight();
            titleBar.setLayoutParams(layoutParams);
            titleBar.setPadding(0, minus, 0 ,0);
