...
public class SwipeBackLayout extends FrameLayout {
    ...
    private boolean mIsPreFragmentAnimationEnable = false;
    ...
    public void setPreFragmentAnimationEnable(boolean enable){
        mIsPreFragmentAnimationEnable = enable;
    }
    ...
    public void computeScroll() {
        ...
        Log.d("ComputeScroll", "mScrimOpacity: " + mScrimOpacity + " mScrollPercent: " + mScrollPercent);
        if (mScrimOpacity >= 0) {
            if (mHelper.continueSettling(true)) {
                ViewCompat.postInvalidateOnAnimation(this);
            }

            if(!mIsPreFragmentAnimationEnable){
                return;
            }
    ...
    private class ViewDragCallback extends ViewDragHelper.Callback {
        ...
        public boolean tryCaptureView(View child, int pointerId) {
            ...
            Log.d("Swipe", "tryCaptureView.dragEnable: " + dragEnable);
            if (dragEnable) {
        ...
        public int clampViewPositionHorizontal(View child, int left, int dx) {
            ...
            Log.d("Swipe", "clampViewPositionHorizontal.ret: " + ret);
            return ret;
        }
        ...
        public int clampViewPositionVertical(@NonNull View child, int top, int dy) {
            ...
            if((mCurrentSwipeOrientation & EDGE_TOP) != 0){
                ...
                Log.d("Swipe", "clampViewPositionVertical.ret: " + ret);
            }
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            if ((mCurrentSwipeOrientation & EDGE_LEFT) != 0) {
                ...
                top = yvel > 0 || yvel == 0 && mScrollPercent > mScrollFinishThreshold ? (childHeight + OVERSCROLL_DISTANCE) : 0;
            }
